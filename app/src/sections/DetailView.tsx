                    ...
                    episodes.map((ep: any) => (
                      <button key={ep.id} onClick={() => {
                        ...
                        if (isMobile && server) {
                          ...
                          window.location.href = buildSteamixIntentUrl(base_url, xtream_user, xtream_pass, parseInt(String(ep.stream_id || ep.id)), ep.container_extension || '', {
                            type: 'series', season: selectedSeason, episode: ep.episode_num || '1'
                          })
                        } else {
