...
export default function Dashboard() {
  ...
  const categoryNameOverride: Record<string, string> = {
    ...
    'ADULT +18 ✦ ANAL': 'YETİŞKİN +18',
    'ADULT +18 ✦ ASIAN': 'YETİŞKİN +18 ASYA',
    'ADULT +18 ✦ BLACK': 'YETİŞKİN +18',
    'ADULT +18 ✦ BIG ASS': 'YETİŞKİN +18',
    'ADULT +18 ✦ BIG TITS': 'YETİŞKİN +18',
    'ADULT +18 ✦ EROTICA FILM': 'YETİŞKİN +18 EROTİK FİLMLER',
    'ADULT +18 ✦ FAKE HUB': 'YETİŞKİN +18',
...
function SlideCategoryPanel({ title, items, selected, onSelect }: { title: string; items: any[]; selected: string; onSelect: (id: string) => void }) {
  const catName = (cat: any) => {
    ...
    const categoryNameOverride: Record<string, string> = {
      ...
      'ADULT +18 ✦ ANAL': 'YETİŞKİN +18', 'ADULT +18 ✦ ASIAN': 'YETİŞKİN +18 ASYA',
      'ADULT +18 ✦ BLACK': 'YETİŞKİN +18', 'ADULT +18 ✦ BIG ASS': 'YETİŞKİN +18',
      'ADULT +18 ✦ BIG TITS': 'YETİŞKİN +18', 'ADULT +18 ✦ EROTICA FILM': 'YETİŞKİN +18 EROTİK FİLMLER',
      'ADULT +18 ✦ FAKE HUB': 'YETİŞKİN +18', 'ADULT +18 ✦ GROUPS': 'YETİŞKİN +18 GRUP',
      'ADULT +18 ✦ HARDCORE': 'YETİŞKİN +18 SERT', 'ADULT +18 ✦ LESBIAN': 'YETİŞKİN +18 LEZBİYEN',
      'ADULT +18 ✦ MASSAGE': 'YETİŞKİN +18 MASAJ', 'ADULT +18 ✦ MILF': 'YETİŞKİN +18',
